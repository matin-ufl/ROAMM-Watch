...
/**
 * This function stores the sensors data into local DB. Since sensors collect data at no predefined sampling rate, the rate used to move them from session storage into local DB is the sampling rate.
 * @author matin
 */
